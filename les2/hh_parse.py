...
vacancies_df = pd.DataFrame(columns=['name', 'company', 'salary_min', 'salary_max', 'salary_currency', 'link', 'site'])
i = 0
...
while True:
    ...
    if response.ok:
        ...
        for vacancy in vacancies_list:
            ...
            vacancies_df.loc[i] = {'name': name, 'company': company, 'salary_min': salary_min, 'salary_max': salary_max,
                                   'salary_currency': salary_currency, 'link': link, 'site': 'hh.ru'}
            i += 1
